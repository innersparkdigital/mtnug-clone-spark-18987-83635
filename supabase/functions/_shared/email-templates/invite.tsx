...
export const InviteEmail = ({ siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join InnerSpark Africa</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          You've been invited to join <Link href={siteUrl} style={link}><strong>InnerSpark Africa</strong></Link>.
