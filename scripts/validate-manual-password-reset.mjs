...
const client = await readFile(new URL("../src/pages/ClientLogin.tsx", import.meta.url), "utf8");
...
const checks = [
  ...
  [client.includes('accountType="client"') && client.includes("client_complete_reset"), "client reset and forced-change flow exists"],
