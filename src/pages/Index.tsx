...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Mental Health Therapy Uganda from UGX 30,000 | InnerSpark</title>
        <meta name="description" content="Talk to a licensed Ugandan therapist by video, voice or chat from UGX 30,000. Private mental health and wellness support across Africa, bookable in 2 minutes." />
        <meta property="og:title" content="Mental Health Therapy Uganda from UGX 30,000 | InnerSpark" />
        <meta property="og:description" content="Talk to a licensed Ugandan therapist by video, voice or chat from UGX 30,000. Private mental health and wellness support across Africa, bookable in 2 minutes." />
