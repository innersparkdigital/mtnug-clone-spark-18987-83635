...
const OnlineTherapyAfricaPost = () => {
  const data: BlogPostData = {
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: "lead",
            text: "Can talking to a therapist on your phone really help you feel better — the same way sitting in a quiet clinic in Kololo would? It is the most common doubt new clients bring to us, and the most reasonable. The honest answer, backed by a decade of research and tens of thousands of African clients, is yes — for most things, and often faster than you would expect.",
          },
          {
            type: "callout",
            label: "The short version:",
            text: "Online therapy in Africa is now as effective as in-person therapy for anxiety, depression, stress, grief, relationship issues, and trauma. It is cheaper, more private, and the only realistic option for the millions of Africans who live far from a qualified therapist.",
          },
          {
            type: "p",
            text: "This guide walks through what the research actually says, where online therapy works best, where in-person care is still the better choice, what it costs in Uganda and across the region, and how to start your first session safely this week.",
          },
        ],
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "Since 2015 dozens of large studies and meta-analyses have compared online and in-person therapy. The pattern is now boringly consistent across cultures and continents.",
          },
          {
            type: "list",
            items: [
          ...
          {
            type: "quote",
            text: "The biggest barrier to therapy in Africa has never been whether it works. It has been access, stigma, and cost. Online therapy quietly removes all three.",
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "p",
            text: "For a teacher in Mbarara, an Uber driver in Nairobi, or a nurse in Gulu, the nearest qualified therapist may be 200 km away. Online therapy is not a compromise for these clients — it is the only realistic option. And research confirms the outcome is the same.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "Online therapy is not the right tool for every situation. Be honest with yourself about these:",
          },
          {
            type: "list",
            items: [
          ...
          },
          {
            ...
            text: (
              <>
                If any of these apply, please visit our{" "}
                <Link to="/emergency-support" className="text-primary hover:underline font-medium">
                  emergency support page
                </Link>{" "}
                or go directly to Butabika Hospital (Uganda) or your nearest psychiatric unit.
              </>
            ),
          },
        ],
      },
      {
        ...
        blocks: [
          {
            type: "numberedCards",
            title: "What happens in your first 3 sessions",
            items: [
          ...
          {
            type: "highlight",
            title: "Nervous about video?",
            text: (
              <>
                You do not have to switch on your camera. Many of our clients start with voice or chat, and only move to video after a few sessions. You can also take our free{" "}
                <Link to="/wellbeing-check" className="text-primary hover:underline font-medium">
                  3-minute wellbeing check
                </Link>{" "}
                first, so you arrive at your first session knowing what to talk about.
              </>
            ),
          },
        ],
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "h3",
            text: "How that compares to in-person care",
          },
          {
            type: "list",
            items: [
          ...
          {
            type: "p",
            text: "Online therapy is cheaper because there is no clinic rent, no front-desk staff, and the therapist can see more clients in a day. Clinical effectiveness is the same.",
          },
        ],
      },
      {
    ...
    faqs: [
      {
        q: "Is online therapy as effective as in-person therapy in Africa?",
        a: "Yes. Research consistently shows online therapy produces the same outcomes as in-person therapy for anxiety, depression, stress, grief, trauma, and relationship issues. Attendance and completion rates are often higher online, because clients face fewer barriers to showing up.",
      },
      {
        q: "How much does online therapy cost in Uganda?",
        a: "At Innerspark Africa, individual sessions are UGX 30,000 to UGX 75,000 per 60-minute session (about $8–$22). Group support is UGX 25,000 per week. Payment is by MTN or Airtel Mobile Money, one session at a time — no subscription needed.",
      },
      {
        q: "What do I need to start online therapy?",
        a: "A smartphone or laptop, stable mobile data (3G is enough), a private space for 60 minutes, and Mobile Money for payment. You can begin with voice or chat sessions if video feels exposing.",
      },
      {
        q: "Is online therapy private and confidential?",
        a: "Yes. Sessions are encrypted and never recorded. Your therapist will not share details with your employer, family, or insurance. The only legal exception, applied worldwide, is immediate risk to your life or someone else's.",
      },
      {
        q: "When should I choose in-person instead?",
        a: "In-person care is the better option for active psychosis, acute suicide risk requiring hospitalisation, severe addiction requiring medical detox, court-ordered assessments, or when you simply have no private space at home.",
      },
      {
        q: "Can I get an InnerSpark therapist outside Uganda?",
        a: "Yes. We see clients across East Africa and the diaspora. Sessions run on WhatsApp, Zoom, or our app, and payment options include Mobile Money, card, and PayPal for clients outside Uganda.",
      },
    ],
    resources: [
    ...
    closing: {
      headline: "Online therapy is not a downgrade. For most Africans, it is finally an upgrade.",
      primary: "The same care, with none of the barriers that kept you away.",
    },
    cta: {
      heading: "Try your first online session this week",
      body: "Sessions from UGX 30,000. Paid by Mobile Money. Private, online, anywhere in Africa.",
      whatsappText:
        "Hi, I just read your article on online therapy in Africa and would like to book a session.",
    },
  };
