...
const StudentTherapyUgandaPost = () => {
  const data: BlogPostData = {
    ...
    metaTitle: "Student Therapy in Uganda from UGX 30,000 — Book Today",
    metaDescription: "Exam stress, family pressure, hostel life — get help this week. Confidential online therapy for Ugandan students from UGX 30,000, Mobile Money, booked in 2 minutes.",
    date: "June 7, 2026",
    isoDate: "2026-06-07",
