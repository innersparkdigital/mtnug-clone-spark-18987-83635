...
const Services = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Mental Health &amp; Wellness Services Across Africa | InnerSpark</title>
        <meta name="description" content="Confidential online therapy and counselling from UGX 30,000, support groups and corporate mental wellness programmes across Uganda and Africa." />
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Mental Health &amp; Wellness Services Across Africa | InnerSpark" />
        <meta property="og:description" content="Confidential online therapy and counselling from UGX 30,000, support groups and corporate mental wellness programmes across Uganda and Africa." />
