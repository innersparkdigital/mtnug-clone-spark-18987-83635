        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              <T>Safe peer spaces to share and heal together under professional moderation. Connect with others who understand your journey.</T>
            </p>
            <div className="flex gap-4 justify-center">
              <a href="https://wa.me/256780570987?text=Hi,%20I%20would%20like%20to%20join%20a%20support%20group" target="_blank" rel="noopener noreferrer">
                <Button size="lg"><T>Join a Group</T></Button>
              </a>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-12 text-center text-foreground">
              <T>Benefits of Support Groups</T>
            </h2>
