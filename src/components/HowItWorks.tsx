      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="bg-card rounded-3xl shadow-xl p-6 md:p-8 lg:p-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left: Steps */}
            <div>
              <h3 className="text-3xl font-bold text-foreground mb-10">{translations.howItWorks}</h3>
              ...
              <div className="flex flex-wrap gap-4 mt-10">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-xs opacity-80">{translations.getItOn}</div>
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-xs opacity-80">{translations.downloadOn}</div>
