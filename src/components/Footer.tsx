        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/for-business/psychometric-assessments" className="hover:text-primary transition-colors">Psychometric Assessments</Link></li>
            ...
            <h4 className="font-display text-base font-semibold mt-6 mb-3">For Companies</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <Link to="/corporate-dashboard" className="hover:text-primary transition-colors">
                  For company or organisation administrators
                </Link>
              </li>
            </ul>
          </div>
        ...
        <nav aria-label="Where we work" className="mb-8 border-t border-border pt-6">
          ...
          <ul className="flex flex-wrap gap-x-4 gap-y-2 text-sm text-muted-foreground">
            {[
              ...
              { to: "/nigeria", label: "Therapy in Nigeria — local pricing" },
              { to: "/tanzania", label: "Therapy in Tanzania" },
              { to: "/ghana", label: "Therapy in Ghana — local pricing" },
              { to: "/gambia", label: "Therapy in The Gambia" },
              { to: "/usa", label: "Therapy for Africans in the USA" },
