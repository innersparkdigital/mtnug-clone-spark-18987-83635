...
const WellbeingHero = ({ onStart }: WellbeingHeroProps) => (
  ...
  >
    ...
    <h1 className="text-4xl sm:text-5xl font-extrabold text-foreground leading-tight mb-2">
      How is your mental
    </h1>
    <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight mb-6">
      <span className="text-primary">wellbeing today?</span>
    </h1>
    ...
    <Button
      onClick={onStart}
      size="lg"
      className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg px-10 py-6 rounded-full shadow-lg shadow-primary/25 mb-6"
    >
      Start Mind-Check
    ...
    <div className="mt-12 text-left bg-card rounded-2xl p-6 border border-border shadow-sm">
      <h2 className="font-bold text-lg text-foreground mb-3">What is the WHO-5?</h2>
